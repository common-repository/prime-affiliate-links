            ...
            <h2 class="nav-tab-wrapper">
				...
				<?php if ( $show_upgrade ) : ?>
                    <a href="<?php echo $fs->get_upgrade_url() ?>"
                       class="nav-tab"><?php echo esc_html( $upgrade_text ) ?></a>
					<?php if ( $fs->apply_filters( 'show_trial', true ) && ! $fs->is_trial_utilized() && $fs->has_trial_plan() ) : ?>
                        <a href="<?php echo $fs->get_trial_url() ?>"
                           class="nav-tab"><?php fs_esc_html_echo_inline( 'Free Trial', 'free-trial', $slug ) ?></a>
					<?php endif ?>
				<?php endif ?>
            </h2>
		<?php endif ?>
            ...
            <div id="fs_account">
                <div class="has-sidebar has-right-sidebar">
                    <div class="has-sidebar-content">
                        <div class="postbox">
                            <h3>
                                <span class="dashicons dashicons-businessman"></span> <?php fs_esc_html_echo_inline( 'Account Details', 'account-details', $slug ) ?>
                            </h3>
                            <div class="fs-header-actions">
                                <ul>
									<?php if ( $fs->is_whitelabeled( true ) ) : ?>
                                        <li>
                                            <a href="#" class="debug-license-trigger"><i
                                                        class="dashicons dashicons-<?php echo $is_whitelabeled ? 'editor-code' : 'controls-pause' ?>"></i>
                                                <span><?php
													if ( $is_whitelabeled ) {
									...
									<?php endif ?>
									<?php if ( $show_billing ) : ?>
                                        <li><a href="#fs_billing"><i
                                                        class="dashicons dashicons-portfolio"></i> <?php fs_esc_html_echo_inline( 'Billing & Invoices', 'billing-invoices', $slug ) ?>
                                        </li>
                                        <li>&nbsp;&bull;&nbsp;</li>
									<?php endif ?>
                                            ...
                                            <li>
                                                <form action="<?php echo $fs->_get_admin_page_url( 'account' ) ?>"
													...
													?>'))  this.parentNode.submit(); return false;"><i
                                                                class="dashicons dashicons-no"></i> <?php fs_esc_html_echo_inline( 'Delete Account', 'delete-account', $slug ) ?>
                                                    </a>
                                                </form>
                                            </li>
                                            <li>&nbsp;&bull;&nbsp;</li>
                                                ...
                                                <li>
                                                    <form action="<?php echo $fs->_get_admin_page_url( 'account' ) ?>"
                                                        ...
                                                        <a href="#"
														   ...
														   } ?> <?php echo esc_attr( $prices_increase_text ) ?> <?php fs_esc_attr_echo_inline( 'Are you sure you want to proceed?', 'proceed-confirmation', $slug ) ?>') ) this.parentNode.submit(); return false;"><i
                                                                    class="dashicons dashicons-download"></i> <?php echo esc_html( $fs->is_only_premium() ? fs_text_inline( 'Cancel Subscription', 'cancel-subscription', $slug ) : $downgrade_text ) ?>
                                                        </a>
                                                    </form>
                                                </li>
                                                <li>&nbsp;&bull;&nbsp;</li>
											...
											<?php if ( ! $fs->is_single_plan() ) : ?>
                                                <li>
                                                    <a href="<?php echo $fs->get_upgrade_url() ?>"><i
                                                                class="dashicons dashicons-grid-view"></i> <?php echo esc_html( $change_plan_text ) ?>
                                                    </a>
                                                </li>
                                                <li>&nbsp;&bull;&nbsp;</li>
											<?php endif ?>
                                            ...
                                            <li>
                                                <form action="<?php echo $fs->_get_admin_page_url( 'account' ) ?>"
                                                    ...
                                                    <a href="#" class="fs-cancel-trial"><i
                                                                class="dashicons dashicons-download"></i> <?php echo esc_html( $cancel_trial_text ) ?>
                                                    </a>
                                                </form>
                                            </li>
                                            <li>&nbsp;&bull;&nbsp;</li>
                                    ...
                                    <li>
                                        <form action="<?php echo $fs->_get_admin_page_url( 'account' ) ?>"
                                            ...
                                            <a href="#" onclick="this.parentNode.submit(); return false;"><i
                                                        class="dashicons dashicons-image-rotate"></i> <?php fs_esc_html_echo_x_inline( 'Sync', 'as synchronize', 'sync', $slug ) ?>
                                            </a>
                                        </form>
                                    </li>
                                </ul>
                                        ...
                                        <tr class="fs-field-<?php echo $p['id'] ?><?php if ( $odd ) : ?> alternate<?php endif ?>">
                                            ...
                                            <td<?php if ( 'plan' === $p['id'] || 'bundle_plan' === $p['id'] ) {
												...
												<?php elseif ( 'beta_program' === $p['id'] ) : ?>
                                                    <label>
                                                        <input type="checkbox"
                                                               class="fs-toggle-beta-mode" <?php checked( true, $p['value'] ) ?>/><span><?php
															...
															<?php else : ?>
                                                                <form action="<?php echo $fs->_get_admin_page_url( 'account' ) ?>"
																	...
																	<?php if ( $show_upgrade && $is_premium ) : ?>
                                                                        <a class="button activate-license-trigger <?php echo $fs->get_unique_affix() ?>"
                                                                           href="#"><?php fs_esc_html_echo_inline( 'Activate License', 'activate-license', $slug ) ?></a>
																	<?php endif ?>
                                                                        ...
                                                                        <a href="<?php echo $fs->get_upgrade_url() ?>"
																		   ...
																		   echo $show_upgrade ?
																			   ...
																			   ' fs-change-plan'; ?> button-upgrade"><i
                                                                                    class="dashicons dashicons-cart"></i> <?php echo esc_html( $show_upgrade ? $upgrade_text : $change_plan_text ) ?>
                                                                        </a>
																	<?php endif ?>
                                                                </form>
															<?php endif ?>
                                                ...
                                                <td class="fs-right">
													...
													( is_string( $user->secret_key ) && in_array( $p['id'], array(
                                                        ...
                                                        <form action="<?php echo $fs->_get_admin_page_url( 'account' ) ?>"
                                                            ...
                                                            <input type="hidden" name="fs_action"
                                                                   value="update_<?php echo $p['id'] ?>">
                                                            <input type="hidden"
                                                                   name="fs_<?php echo $p['id'] ?>_<?php echo $fs->get_unique_affix() ?>"
                                                                   value="">
													...
													<?php elseif ( 'user_id' === $p['id'] && ! empty( $ids_of_installs_activated_with_foreign_licenses ) ) : ?>
                                                        <input id="fs_change_user" type="submit"
						...
						<?php if ( fs_is_network_admin() ) : ?>
                            <div id="fs_sites" class="postbox">
                                <h3>
                                    <span class="dashicons dashicons-networking"></span> <?php fs_esc_html_echo_inline( 'Sites', 'sites', $slug ) ?>
                                </h3>
                                <div class="fs-header-actions">
									<?php if ( ! $is_whitelabeled ) : ?>
										...
										<?php if ( $has_license || ( $show_upgrade && $is_premium ) ) : ?>
											...
											?>
                                            <a class="button<?php echo( ! $has_license ? ' button-primary' : '' ) ?> activate-license-trigger <?php echo $fs->get_unique_affix() ?>"
                                               href="#"><?php echo $activate_license_button_text ?></a>
										<?php endif ?>
									<?php endif ?>
                                    <input class="fs-search" type="text"
                                           placeholder="<?php fs_esc_attr_echo_inline( 'Search by address', 'search-by-address', $slug ) ?>..."><span
